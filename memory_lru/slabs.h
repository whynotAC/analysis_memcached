 ...
 * up from (if true), or allocate memory in chunks as it is needed(if false)
 */
...
/**
 * Given object size, return id to use when allocating/freeing memroy for object
...
/* Ajust the stats for memory requested */
