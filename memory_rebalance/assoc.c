...
static void assoc_expand(void) {
    ...
    if (primary_hashtable) {
        ...
        /* Bad news, but we can keep runnig*/
    }
}
...
static void *assoc_maintenance_thread(void *arg) {
    ...
    while (do_run_maintenance_thread) {
        ...
        for (ii = 0; ii < hash_bulk_move && expanding; ++ii) {
             ...
             * is the lowest N bits of the hv, and the bucket of item_locks
             * is also the lowest N bits of hv, and N is greater than M.
             * So we can process expanding with only one item_lcok. cool!
             */
        ...
        if (!expanding) {
             ...
             * this is instead of a more complex, possibly slower algorithm
