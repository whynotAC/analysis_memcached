...
// how many powers of 2's worth of buckets we are
 ...
 * far we're gotten so far. Ranges form 0 .. hashsize(hashpower - 1) - 1
 */
...
// grow the hashtable to the next power of 2.
...
static void *assoc_maintenance_thread(void *arg) {
    ...
    while (do_run_maintenance_thread) {
        ...
        for (ii = 0; ii < hash_bulk_move && expanding; ++ii) {
            ...
            /*
             * bucket = hv & hashmask(hashpower) => the bucket of hash
             * table is the lowest N bits of the hv, and the bucket of 
             * item_locks is also the lowest M bits of hv, and N is 
             * greater than M.
