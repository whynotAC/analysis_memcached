 ...
 */
typedef struct {
    /** Mutex to protexct access to the structure */
 ...
 * purposes and help you track down what kind of object you have problems with
 ...
 * need to allocate more memory from the as.
 * @pram destructor the function to be called before we release the memory back
 * to the as.
 * @return a hadnle to an object cache if successful, NULL otherwise
 */
 ...
 * invalidated)
 *
 * @param handle the handle to the oejct cahe to destroy.
 */
 ...
 * the allocation cannot be statisfied.
 */
 ...
 *
 * @param handle handle to the object cache to return this object to
